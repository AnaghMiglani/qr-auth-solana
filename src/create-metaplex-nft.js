...
export function createMetaplexNft(serialNumber_1, productName_1) {
    return __awaiter(this, arguments, void 0, function (serialNumber, productName, imgurLink) {
        var connection, secretKey, user, umi, umiKeypair, collectionNftAddress, uri, mint, explorerLink, qrCodePath, qrCode, error_1;
        if (imgurLink === void 0) { imgurLink = "https://i.imgur.com/GB3znw2.png"; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, airdropIfRequired(connection, user.publicKey, 1 * LAMPORTS_PER_SOL, 0.1 * LAMPORTS_PER_SOL)];
                case 1:
                    // Airdrop SOL if required
                    _a.sent();
                    ...
                    collectionNftAddress = UMIPublicKey("AuU7XLbwyoNsFMnAEfzbLtekL4GjFAydXxfsd5YTBrtC");
                    return [4 /*yield*/, umi.uploader.uploadJson({
                            name: serialNumber,
                            symbol: productName,
                            image: imgurLink,
                ...
                case 3:
                    ...
                    return [4 /*yield*/, QRCode.toDataURL(explorerLink, { width: 300, margin: 1 })];
                case 4:
                    qrCode = _a.sent();
                    return [4 /*yield*/, fs.writeFile(qrCodePath, qrCode.replace(/^data:image\/png;base64,/, ""), "base64")];
                case 5:
                    _a.sent();
