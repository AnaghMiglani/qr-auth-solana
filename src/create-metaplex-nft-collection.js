...
function createCollection(product_type) {
    return __awaiter(this, void 0, void 0, function () {
        var connection, umi, secretKey, user, umiKeypair, collectionMint, uri, explorerLink, qrCodePath, qrCode, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    connection = new web3_js_1.Connection((0, web3_js_1.clusterApiUrl)("devnet"));
                    umi = (0, umi_bundle_defaults_1.createUmi)(connection);
                    secretKey = process.env.SECRET_KEY;
                    if (!secretKey) {
                        throw new Error("SECRET_KEY is not defined in the environment variables.");
                    }
                    user = web3_js_1.Keypair.fromSecretKey(Uint8Array.from(JSON.parse(secretKey)));
                    return [4 /*yield*/, (0, helpers_1.airdropIfRequired)(connection, user.publicKey, 1 * web3_js_1.LAMPORTS_PER_SOL, 0.1 * web3_js_1.LAMPORTS_PER_SOL)];
                case 1:
                    _a.sent();
                    ...
                    collectionMint = (0, umi_1.generateSigner)(umi);
                    uri = "{product_type=".concat(product_type, "}");
                    // Create and mint NFT
                    return [4 /*yield*/, (0, mpl_token_metadata_1.createNft)(umi, {
                            mint: collectionMint,
                            name: product_type,
                            uri: uri,
                ...
                case 2:
                    // Create and mint NFT
                    _a.sent();
                    explorerLink = (0, helpers_1.getExplorerLink)("address", collectionMint.publicKey, "devnet");
                    console.log("Collection NFT:  ".concat(explorerLink));
                    console.log("Collection NFT address is:", collectionMint.publicKey);
                    console.log("✅ Finished successfully!");
                    qrCodePath = path_1.default.join(__dirname, "collection_qr_code.png");
                    return [4 /*yield*/, qrcode_1.default.toDataURL(explorerLink, {
                            width: 300,
                            margin: 1,
                        })];
                case 3:
                    qrCode = _a.sent();
                    return [4 /*yield*/, fs_1.promises.writeFile(qrCodePath, qrCode.replace(/^data:image\/png;base64,/, ""), "base64")];
                case 4:
                    _a.sent();
                    console.log("QR Code saved at:", qrCodePath);
                    return [2 /*return*/, explorerLink];
                case 5:
                    error_1 = _a.sent();
